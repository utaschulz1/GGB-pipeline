...
description: "Informmation for all meal plans"
language: "en"
---
...
**Using dry beans and home-made stock:** If you want to use food as unprocessed as possible, see the schedule to soak the beans the night before and cook them in the slow cooker in time. See [How to Cook Beans](#how-to-cook-beans). Also, you can prepare your own vegetable stock.
...
2. Put the beans into the slow cooker, start the slow cooker at 95°C and set the timer:
...
4. Fill up with boiling water until at least 2cm above the beans
5. Optional: Add 1 tomato, 1 onion, 1 carrot and leftover leek to the beans. You can use the cooking water as stock for recipes like Green Dhal or for soups.
6. Put a strainer on a pan and strain the stock to keep it. Otherwise, strain off the water. Keep cooked beans and stock in a **closed container** in the fridge until you need them.
...
2. Wash the ingredients and chop or grate them.
3. Add salt, pepper, olive oil and lemon juice or vinegar.
4. Make notes on what you like and how much you need to adjust your shopping list for next time.

![Simple salad: lettuce, carrots, tomato](images/toplevel-imgs/salad-as-side_16x9.jpg)
